...
export default function LikedSection({ loading }: Props) {
  ...
  return (
    <>
      ...
      <div className={
          showLiked ?
          'w-full h-[167px] bg-darkPurple border-t-0 rounded-b-[16px] p-[16px] border-solid border-[1px] border-cardLoader border-opacity-[44%] flex flex-row justify-between items-center duration-300':
          'w-full h-[0px] bg-darkPurple  border-t-0 rounded-b-[16px] p-[16px] border-solid border-[1px] border-cardLoader border-opacity-[44%] flex flex-row justify-between duration-300 transform -translate-y-1  opacity-0 -z-10'}>

            <div className="w-full h-full flex flex-col items-center justify-center">
                <Image src={mediumHeart} alt="small heart" className="h-[34px] w-[33px] mb-[15px]" />
              <h1 className="text-white font-primary_Medium text-[15px] text-center">You haven’t liked any superhero yet</h1>
            </div>
          </div>
    </>
  );
